class AppStrings {
  ...
  String get hey => "Hey";
  String get welcomeApp => "Welcome to our app";
  ...
  String get passwordLengthError => "Password must be 8 digits.";

  String get strongPasswordError =>
      'Password must contain at least 1 special character, 1 capital letter, and 1 numeric digit.';

  String get fNameError => "Enter a valid first name.";

  String get lNameError => "Enter a valid last name.";
  ...
  String get signUpMessage => "Just a few quick things to get started";
